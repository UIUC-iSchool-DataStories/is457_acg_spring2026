...
notes:
So, first I'll show you a version of a slide in one of my talks.

The context for this slide is that I'm introducing a corpus of historical texts that we want to "digitize" (i.e. make machine-readable.)
